        ...
        {BRANDS.map((brand, index) => {
          ...
          return (
            <div
              ...
              className={`group cursor-pointer relative overflow-hidden rounded-2xl p-6 transition-all duration-500 border backdrop-blur-xl flex flex-col justify-between items-center text-center ${isSelected
            ...
            >
              ...
              <div className="relative z-10">
                <h3
                  className={`text-xl font-bold transition-colors ${isSelected ? 'text-emerald-400' : 'text-white group-hover:text-emerald-300'
                    }`}
                >
                  {brand.name}
                </h3>
              ...
              <div
                className={`mt-4 px-4 py-1 rounded-full text-xs font-semibold uppercase tracking-wider transition-all ${isSelected
